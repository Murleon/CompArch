...
wire opcode:8, icode:4, rB:4, valC:64, increment: 64; 
...
rB = i10bytes[8..12]; ##Might be 12-16??
valC = i10bytes[16..80]; #the immediate value

/* we could also have done i10bytes[4..8] directly*/
...
p_pc = P_pc + increment; # you may use math ops directly...
