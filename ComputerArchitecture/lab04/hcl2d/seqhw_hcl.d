...
int tick(bool showpc=true, bool showall=false) {
    ...
    ulong _HCL_rB = (((_HCL_icode)==(7)) ? (15) :
		(cast(ulong)(((_HCL_i10bytes)>>8UL)&0xf)));
    _HCL_rB &= 0xf;
    if (showall) writefln("set rB to 0x%x",_HCL_rB);
    ulong _HCL_rA = (((_HCL_icode)==(7)) ? (15) :
		(cast(ulong)(((_HCL_i10bytes)>>12UL)&0xf)));
    _HCL_rA &= 0xf;
    ...
    ulong _HCL_conditionsMet = (((_HCL_ifun)==(0)) ? (1UL) :
    ...
    ulong _HCL_reg_dstE = (((!_HCL_conditionsMet)&&((_HCL_icode)==(2))) ? (15) :
		(((((_HCL_icode)==(3)))||(((_HCL_icode)==(2))))||(((_HCL_icode)==(6)))) ? (_HCL_rB) :
		(((_HCL_icode)==(5))) ? (_HCL_rA) :
		(((((_HCL_icode)==(11)))||(((_HCL_icode)==(8))))||(((_HCL_icode)==(9)))) ? (4) :
		(15));
    _HCL_reg_dstE &= 0xf;
    ...
    ulong _HCL_reg_srcA = ((((((((_HCL_icode)==(2)))||(((_HCL_icode)==(6))))||(((_HCL_icode)==(4))))||(((_HCL_icode)==(10))))) ? (_HCL_rA) :
		(15));
    _HCL_reg_srcA &= 0xf;
    if (showall) writefln("set reg_srcA to 0x%x",_HCL_reg_srcA);
    ulong _HCL_reg_srcB = ((((((((_HCL_icode)==(2)))||(((_HCL_icode)==(6))))||(((_HCL_icode)==(4))))||(((_HCL_icode)==(5))))) ? (_HCL_rB) :
    ...
    ulong _HCL_valE = ((((_HCL_icode)==(6))&&((_HCL_ifun)==(3))) ? ((_HCL_reg_outputA)^(_HCL_reg_outputB)) :
    ...
    ulong _HCL_mem_input = (((((_HCL_icode)==(4)))||(((_HCL_icode)==(10)))) ? (_HCL_reg_outputA) :
		(((_HCL_icode)==(8))) ? ((_HCL_P_pc)+(_HCL_increment)) :
		0);
    _HCL_mem_input &= 0xffffffffffffffff;
    if (showall) writefln("set mem_input to 0x%x",_HCL_mem_input);
    ulong _HCL_mem_addr = (((((((_HCL_icode)==(4)))||(((_HCL_icode)==(5))))||(((_HCL_icode)==(10))))||(((_HCL_icode)==(8)))) ? (_HCL_valE) :
		((((_HCL_icode)==(11)))||(((_HCL_icode)==(9)))) ? (_HCL_reg_outputB) :
		0);
    ...
    ulong _HCL_reg_inputE = (((_HCL_icode)==(3)) ? (_HCL_valC) :
		...
		((((((_HCL_icode)==(6)))||(((_HCL_icode)==(11))))||(((_HCL_icode)==(8))))||(((_HCL_icode)==(9)))) ? (_HCL_valE) :
		0);
    ...
    ulong _HCL_p_pc = ((((_HCL_icode)==(7))&&(_HCL_conditionsMet)) ? (_HCL_valC) :
		(((_HCL_icode)==(8))) ? (_HCL_valC) :
		(((_HCL_icode)==(9))) ? (_HCL_mem_output) :
		((_HCL_P_pc)+(_HCL_increment)));
...
pragma(msg,`Estimated clock delay: 133`);
enum tpt = 133;
