...
int tick(bool showpc=true, bool showall=false) {
    ...
    ulong _HCL_reg_srcA = (((((((_HCL_icode)==(2)))||(((_HCL_icode)==(6))))||(((_HCL_icode)==(4))))) ? (_HCL_rA) :
		((((_HCL_icode)==(7)))) ? (15) :
		(15));
    _HCL_reg_srcA &= 0xf;
    if (showall) writefln("set reg_srcA to 0x%x",_HCL_reg_srcA);
    ulong _HCL_reg_srcB = (((((((_HCL_icode)==(2)))||(((_HCL_icode)==(6))))||(((_HCL_icode)==(4))))) ? (_HCL_rB) :
		(15));
    _HCL_reg_srcB &= 0xf;
    if (showall) writefln("set reg_srcB to 0x%x",_HCL_reg_srcB);
    ulong _HCL_mem_readbit = (((_HCL_icode)==(4)) ? (0UL) :
		((_HCL_icode)==(5)) ? (1UL) :
		(15));
    ...
    ulong _HCL_valE = _HCL_reg_inputE;
...
pragma(msg,`Estimated clock delay: 110`);
enum tpt = 110;
